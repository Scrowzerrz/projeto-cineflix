    ...
    >
      ...
      <div className={`absolute inset-0 bg-black/75 flex flex-col justify-center items-center p-3 transition-opacity duration-300 ${isHovered ? 'opacity-100' : 'opacity-0'}`}>
        <Button 
          variant="default" 
          size="sm" 
          className="w-full mb-2 bg-movieRed hover:bg-movieRed/90 text-white flex items-center justify-center gap-1 rounded-sm"
        >
        ...
        <div className="flex justify-between w-full mt-2">
          <Button 
            variant="ghost" 
            size="sm" 
            className="flex-1 rounded-sm bg-white/10 hover:bg-white/20 text-white"
          >
          ...
          <Button 
            variant="ghost" 
            size="sm" 
            className="flex-1 rounded-sm bg-white/10 hover:bg-white/20 text-white ml-2"
          >
